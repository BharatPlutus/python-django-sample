...
from common_config.api_code import HTTP_400_BAD_REQUEST, HTTP_201_CREATED, HTTP_OK
from common_config.api_message import UNEXPECTED_ERROR, EXTRA_QUERY_PARAMS, INVALID_PAGE_SIZE, \
    INVALID_PAGE_NUMBER, BLANK_PARAM, INVALID_BOOLEAN_FLAG, INVALID_SORT_BY, ADD_ADDRESS, DELETE_ADDRESS, \
    UPDATE_ADDRESS, NOT_FOUND_JSON_DATA
from utils.api_response import APIResponse
from utils.permissions import IsAuthorized
from utils.pagination import Pagination

from addresses.models.admin_address import AdminAddress
from addresses.serializers.admin_address import AddressListSerializer, AddressCreateUpdateSerializer, \
    AddressViewSerializer
from utils.verify_address import EasyPostAddressVerification, LobAddressVerification


class AdminAddressesListCreateView(ListCreateAPIView):
    """
    ...
    queryset = AdminAddress.objects.all()
    serializer_class = AddressCreateUpdateSerializer
    permission_classes = (IsAuthenticated, IsAuthorized,)
    permission_required = ('view_adminaddress', 'add_adminaddress', )
    request_path = None
    pagination_class = Pagination
    query_filter_params = ["is_active", "include_deleted", "page", "page_size", "sort_by", "search"]
        ...
        if "include_deleted" in self.params:
            try:
                ...
                if not self.errors:
                    ...
                    IsAuthorized.has_include_deleted_permission(self.request, "view_adminaddress")

    def filter_queryset(self, params):
        filter_kwargs = {"store_id": None, "is_active": True}
    ...
    def get(self, request, *args, **kwargs):
        ...
        return self.paginator.generate_response(queryset, AddressListSerializer, request, is_pagination)
...
class AdminAddressesRetrieveUpdateDeleteView(RetrieveUpdateDestroyAPIView):
    """
    ...
    serializer_class = AddressCreateUpdateSerializer
    permission_classes = (IsAuthenticated, IsAuthorized,)
    permission_required = ('change_adminaddress', 'view_adminaddress', 'delete_adminaddress', )
    lookup_field = 'pk'
    ...
    def get_object(self):
        ...
        # get object
        obj = get_object_or_404(queryset, "address_id", **filter_kwargs)
        return obj
    ...
    def delete(self, request, *args, **kwargs):
        ...
        return APIResponse({"message": DELETE_ADDRESS}, HTTP_OK)
